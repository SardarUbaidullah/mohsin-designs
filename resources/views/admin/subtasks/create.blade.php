...
<div class="max-w-4xl mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Create New Subtask</h1>
            <p class="text-gray-600 mt-2">Add a new subtask to break down complex tasks</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-6">
            <form action="{{ route('subtasks.store') }}" method="POST" class="space-y-6">
                @csrf
