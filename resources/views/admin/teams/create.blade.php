...
<div class="container mx-auto px-4 py-6 max-w-2xl">
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Add a new team to the system</p>
    </div>

    <form action="{{ route('teams.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        @csrf
